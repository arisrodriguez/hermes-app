  ...
  return (
    <section className="w-full">
      <form
        ...
        className="hermes-form mx-auto max-w-xl rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-[0_24px_70px_rgba(23,32,51,0.12)] sm:p-8"
        id="Form"
      >
        <div className="mb-8 flex items-start justify-between gap-4">
          <div>
            ...
            <h2 className="text-2xl font-extrabold tracking-tight text-slate-950">
              Build your training map
            </h2>
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Use your latest test data for a more useful result.
            </p>
          </div>
          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-yellow-400 text-lg font-extrabold text-blue-900">
            01
          </span>
        </div>
        ...
        <button
          type="submit"
          aria-label="Calculate your training zones"
          className="w-full cursor-pointer py-2 px-6 bg-transparent border border-white text-white rounded-lg hover:border hover:bg-white hover:text-blue-600 transition-all duration-300 ease-in-out"
        >
